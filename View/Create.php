    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-black mb-3 animated slideInDown">Post 
				A Job</h1>
		...
		<div class="container">
			...
			<form method="post" action="../Controller/job_actions.php">
				...
				<textarea id="description" name="description" placeholder="Enter job description" required rows="4"></textarea>
				<label for="requirements">Requirements:</label>
				<textarea id="requirements" name="requirements" placeholder="Enter job requirements" required rows="4"></textarea>
				<label for="company_id">Company ID:</label>
				<input type="number" id="company_id" name="company_id" placeholder="Enter company ID" required>
